...
A \sbmlwarning small spacing problem can occur when \cmd{primtypeNC} is used in
...
\item[\cmd{sbmlwarning}] Puts \sbmlwarning a warning sign in the left margin
  (illustrated at the left).  The symbol will always be displayed.
...
The commands \cmd{notice} and \cmd{sbmlwarning} are intended to be used for
